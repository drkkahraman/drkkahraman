...
- [TEDcepte](https://tedcepte.dorukk.dev) - Halen kullanılmakta olan ve okulum tarafından desteklenen öğrenci sosyal medyası
...
## Araç Setim & Donanım
- **Diller:** Python, HTML
- **Frameworkler:** PyTorch, Ollama
- **Sistem:** Linux (Ubuntu 22.04), Ollama

---
*8. sınıfın ders disiplini ile yapay zekaya duyulan teknik tutkunun bir araya gelmiş hali.*
