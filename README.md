...
- Ubuntu 22.04 ortamında, tamamen yerel donanım kullanarak 200M - 400M parametreli özgün modeller geliştiriyorum.
- **Gelecek Planım:** Şu an hobi ve açık kaynaklı proje olarak yürüttüğüm bu çalışmaları, Temmuz - Ağustos 2026 civarında profesyonel bir girişime dönüştürmeyi hedefliyorum.
...
- [Hugging Face Profilim](https://huggingface.co/drkkahraman) - Eğittiğim Açık Kaynaklı Modeller
...
1. Zaman tasarrufu sağlayarak odağımı tamamen yapay zeka mimarileri ve model eğitimine verebilmek.
2. Modern yapay zeka araçlarının yazılım geliştirme süreçlerindeki sınırlarını ve potansiyelini bizzat deneyimleyerek öğrenmek.

## Teknik Uzmanlık Alanlarım
- **Model Optimizasyonu:** Düşük kaynaklı cihazlar için GGUF ve Quantization (INT4/INT8) süreçleri.
